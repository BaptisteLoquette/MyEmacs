...
pip install matplotlib seaborn plotly kaleido numpy scipy polars
pip install schemdraw altair manim pyvista
...
echo "Run: python docs/superpowers/viz-framework/install/verify-install.py"
